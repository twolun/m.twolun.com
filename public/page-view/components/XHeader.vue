<template>
  <div class="vux-header">
    <div class="vux-header-left">
      <a class="vux-header-back" v-show="leftOptions.showBack" :transition="transition" v-touch:tap="onClickBack">{{leftOptions.backText}}</a>
...
<style lang="less">
@x-header-background-color: #2196f3;
@x-header-title-color: #fff;
@x-header-text-color: #fff;
@x-header-arrow-color: #fff;
